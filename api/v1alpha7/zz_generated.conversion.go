...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ServerGroupFilter)(nil), (*v1alpha8.ServerGroupFilter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha7_ServerGroupFilter_To_v1alpha8_ServerGroupFilter(a.(*ServerGroupFilter), b.(*v1alpha8.ServerGroupFilter), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha8.ServerGroupFilter)(nil), (*ServerGroupFilter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha8_ServerGroupFilter_To_v1alpha7_ServerGroupFilter(a.(*v1alpha8.ServerGroupFilter), b.(*ServerGroupFilter), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha7_OpenStackMachineSpec_To_v1alpha8_OpenStackMachineSpec(in *OpenStackMachineSpec, out *v1alpha8.OpenStackMachineSpec, s conversion.Scope) error {
	...
	out.ServerGroup = (*v1alpha8.ServerGroupFilter)(unsafe.Pointer(in.ServerGroup))
	out.IdentityRef = (*v1alpha8.OpenStackIdentityReference)(unsafe.Pointer(in.IdentityRef))
	return nil
}
...
func autoConvert_v1alpha8_OpenStackMachineSpec_To_v1alpha7_OpenStackMachineSpec(in *v1alpha8.OpenStackMachineSpec, out *OpenStackMachineSpec, s conversion.Scope) error {
	...
	out.ServerGroupID = in.ServerGroupID
	out.ServerGroup = (*ServerGroupFilter)(unsafe.Pointer(in.ServerGroup))
	out.IdentityRef = (*OpenStackIdentityReference)(unsafe.Pointer(in.IdentityRef))
	return nil
}
...
func autoConvert_v1alpha7_ServerGroupFilter_To_v1alpha8_ServerGroupFilter(in *ServerGroupFilter, out *v1alpha8.ServerGroupFilter, s conversion.Scope) error {
	out.ID = in.ID
	out.Name = in.Name
	return nil
}

// Convert_v1alpha7_ServerGroupFilter_To_v1alpha8_ServerGroupFilter is an autogenerated conversion function.
func Convert_v1alpha7_ServerGroupFilter_To_v1alpha8_ServerGroupFilter(in *ServerGroupFilter, out *v1alpha8.ServerGroupFilter, s conversion.Scope) error {
	return autoConvert_v1alpha7_ServerGroupFilter_To_v1alpha8_ServerGroupFilter(in, out, s)
}

func autoConvert_v1alpha8_ServerGroupFilter_To_v1alpha7_ServerGroupFilter(in *v1alpha8.ServerGroupFilter, out *ServerGroupFilter, s conversion.Scope) error {
	out.ID = in.ID
	out.Name = in.Name
	return nil
}

// Convert_v1alpha8_ServerGroupFilter_To_v1alpha7_ServerGroupFilter is an autogenerated conversion function.
func Convert_v1alpha8_ServerGroupFilter_To_v1alpha7_ServerGroupFilter(in *v1alpha8.ServerGroupFilter, out *ServerGroupFilter, s conversion.Scope) error {
	return autoConvert_v1alpha8_ServerGroupFilter_To_v1alpha7_ServerGroupFilter(in, out, s)
}
